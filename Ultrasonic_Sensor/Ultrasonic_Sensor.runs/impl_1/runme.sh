...
HD_PWD='D:/project_codes/EDGE_Digital_Sensor_Addon/Zynq_Z20_Sensor_codes/Ultrasonic_Sensor/Ultrasonic_Sensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Range_Sensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Range_Sensor.tcl -notrace
