...
HD_PWD='D:/project_codes/EDGE_Digital_Sensor_Addon/Zynq_Z20_Sensor_codes/Ultrasonic_Sensor/Ultrasonic_Sensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Range_Sensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Range_Sensor.tcl
