...
HD_PWD='D:/project_codes/EDGE_Digital_Sensor_Addon/Zynq_Z20_Sensor_codes/Touch_Sensor/Touch_Sensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOUCH.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOUCH.tcl -notrace
