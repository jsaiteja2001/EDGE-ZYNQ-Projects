...
HD_PWD='D:/project_codes/EDGE_Digital_Sensor_Addon/Zynq_Z20_Sensor_codes/Touch_Sensor/Touch_Sensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOUCH.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOUCH.tcl
