...
HD_PWD='D:/project_codes/EDGE_Digital_Sensor_Addon/Zynq_Z20_Sensor_codes/Accelerometer/Accelerometer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accelerometer_adxl345.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accelerometer_adxl345.tcl
