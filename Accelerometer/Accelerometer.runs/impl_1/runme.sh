...
HD_PWD='D:/project_codes/EDGE_Digital_Sensor_Addon/Zynq_Z20_Sensor_codes/Accelerometer/Accelerometer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log accelerometer_adxl345.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source accelerometer_adxl345.tcl -notrace
