...
HD_PWD='D:/project_codes/motor_addon/Z20/Servo_Motor/Servo_Motor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log servo_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source servo_controller.tcl -notrace
