...
HD_PWD='D:/project_codes/motor_addon/Z20/Servo_Motor/Servo_Motor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log servo_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source servo_controller.tcl
