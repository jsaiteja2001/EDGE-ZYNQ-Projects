...
HD_PWD='C:/Users/jsait/Desktop/EDGE ZNYQ/EDGE Digital Sensor/Zynq_Z20_Sensor_codes/Gesture_Sensor/Gesture_Sensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gesture1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gesture1.tcl -notrace
