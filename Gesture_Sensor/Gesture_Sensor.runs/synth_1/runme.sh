...
HD_PWD='D:/project_codes/EDGE_Digital_Sensor_Addon/Zynq_Z20_Sensor_codes/Gesture_Sensor/Gesture_Sensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gesture1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gesture1.tcl
